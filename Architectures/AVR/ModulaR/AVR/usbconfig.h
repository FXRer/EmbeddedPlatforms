...
#define  USB_CFG_VENDOR_ID       (uint8_t)'D', (uint8_t)'G'
 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       (uint8_t)'C', (uint8_t)'P'
...
//#define USB_CFG_HID_REPORT2_DESCRIPTOR_LENGTH    35
/* Define this to the length of the HID report descriptor, if you implement
 * an HID device. Otherwise don't define it or define it to 0.
 * If you use this define, you must add a PROGMEM character array named
 * "usbHidReport2Descriptor" to your code which contains the report descriptor.
 * Don't forget to keep the array and this define in sync!
 */
...
#define USB_CFG_DESCR_PROPS_HID2                    0
