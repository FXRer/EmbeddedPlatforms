...
/** Thr3 related **/
#define RtcReqSig   0       /* Request RTC operation (read/write) */
...
#define RtcLockBit      3       /* RTC register access lock */
#define RtcOpBit        4       /* RTC: define the type of operation: 1 --> read, 0 --> write
                                 * valid whan RTCLockBit is 1 */
