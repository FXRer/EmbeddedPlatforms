...
#define RX_DOUBLE_BUFFER 0  /* Use 2 Rx-Buffers alternatively */
#define TX_QUEUE    0       /* Use 4 Registers as Tx-Queue */

#define TRACERX_BIT 1
#define TRACEBITERR 0
#define TRACERXERR  1
#define TRACEBUSOFF 1
#define TRACELOSTARB 1
...
#undef DEBUG_ECHO
#undef CANDONGLE_DEBUG_TIMING
#undef CANDONGLE_DEBUG_SLOW
#undef CANDONGLE_DEBUG_BITS
#undef CANDONGLE_DEBUG_STUFF
*/
...
#define     CanTxP          2      /* Out */
#define		CAN_TXDIR_PORT	DDRB
#define		CAN_TXOUT_PORT	PORTB
...
/* Led Pins */
#define     LedBusTxP       5   /* rs232-Rx CanTx LD2 (Green) */
#define     LedBusRxP       3   /* rs232-Tx CanRx LD3 (Red) */
#define     LedYellowP      4
/*#define     LedLoadP        0     * To see Processor load/work */
...
#define     TraceRxBitP     0	/* enabled when TRACERX_BIT==1 */
#define     TraceInt0P      1	/* enabled when TRACERX_BIT==1 */

#define     TraceResyncNeg  2	/* enabled when TRACERESYNC==1 */
#define     TraceResyncPos  3	/* enabled when TRACERESYNC==1 */

#define     TraceBitErrP    0	/* enabled when TRACEBITERR==1 */
#define     TraceStuffErrP  1	/* enabled when TRACEBITERR==1 */
#define     TraceCrcErrP    2	/* enabled when TRACEBITERR==1 */
#define     TraceFormErrP   3	/* enabled when TRACEBITERR==1 */

#define     TraceRxErrP     4	/* enabled when TRACERXERR==1 */
#define     TraceBusOffP    5	/* enabled when TRACEBUSOFF==1 */

#define     TraceLostArbB   3	/* enabled when TRACELOSTARB==1 */
